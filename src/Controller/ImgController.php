...
{
    #[Route('/marketplace/img/upload', name: 'img.upload')]
    ...
    #[Route('/marketplace/img/load/{id<\d+>}', name: 'img.load', methods: ['GET'])]
    ...
    #[Route('/marketplace/img/delete/{id<\d+>}', name: 'img.delete', methods: ['GET'])]
